...
from mapof.roommates.objects.RoommatesExperiment import RoommatesExperiment
from mapof.roommates.objects.Roommates import Roommates
from mapof.roommates import cultures_ as rom
from mapof.roommates.distances_ import get_distance
